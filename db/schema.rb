...
ActiveRecord::Schema.define(version: 20170111202236) do
  ...
  add_index "publications", ["data_publikacji", "pozycja"], name: "index_publications_on_data_publikacji_and_pozycja", unique: true, using: :btree
